...
#define NO_PIN				 26
#define GPIO_PORT(__PIN__)   T020_IO[__PIN__].PORT//((__PIN__ <= 15 ) ? GPIOA : ((__PIN__) <= (19))? GPIOB : GPIOF)
#define GPIO_PIN(__PIN__)    T020_IO[__PIN__].PIN //(1 << ((__PIN__ <= 15 ) ? (__PIN__) : ((__PIN__) <= (19))? (__PIN__ - 16) : (__PIN__ - 20)))	
