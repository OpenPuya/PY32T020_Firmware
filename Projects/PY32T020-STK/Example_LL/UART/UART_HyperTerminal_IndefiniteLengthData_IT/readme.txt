...
注意事项：
1. 建议去掉STK板上R19\R20
2. 用户可根据需要修改main.h中宏RX_MAX_LEN的值，RX_MAX_LEN定义了MCU单次接收数据长
度（当前样例为128bytes）。

Notes:
1. It is recommended to remove R19\R20 from STK board
2. Users can modify the values of macros RX_MAX_LEN in main.h as  needed. 
RX_MAX_LEN defines the length of data received by MCU for a single time
(currently 128bytes).
================================================================================