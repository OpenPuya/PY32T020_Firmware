...
================================================================================
功能描述：
此样例演示了在deepstop模式下，使用GPIO事件唤醒。

Function descriptions:
This sample demonstrates using GPIO event to wake up the MCU from deepstop mode.
================================================================================
测试环境：
测试用板：PY32T020_STK
MDK版本： 5.28
...
3.Note that PY32T020B model does not support deepstop mode
================================================================================