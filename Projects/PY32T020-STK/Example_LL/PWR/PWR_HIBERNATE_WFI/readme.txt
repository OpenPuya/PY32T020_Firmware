...
================================================================================
功能描述：
此样例演示了在hibernate模式下，使用GPIO中断唤醒。

Function descriptions:
This sample demonstrates using GPIO interrupt to wake up the MCU from hibernate mode.
================================================================================
测试环境：
测试用板：PY32T020_STK
MDK版本： 5.28
...
使用步骤：
1. 编译下载程序到MCU，并运行；
2. LED灯亮，按下按键，LED灯灭，进入hibernate模式；
3. 在PA06上产生一个下降沿，程序退出hibernate模式；
4. LED以200ms的间隔进行翻转。

Example execution steps:
1.Compile and download the program to the MCU and run it.
2.The LED lights up. Press the button, and the LED turns off, entering hibernate mode.
3.Generate a falling edge on PA06 to wake up the MCU from hibernate mode.
