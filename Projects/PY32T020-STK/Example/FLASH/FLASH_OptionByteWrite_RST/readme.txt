...
4. 注释掉"OB_GPIO_PIN_MODE OB_NRST_MODE_GPIO",打开"OB_GPIO_PIN_MODE 
OB_NRST_MODE_NRST",编译重新下载到MCU;
5. 将MCU断电并重新上电；
...
4. Annotate "OB_GPIO_PIN_MODE OB_NRST_MODE_GPIO" and open "OB_GPIO_PIN_MODE 
OB_NRST_MODE_NRST",Compile and download again to MCU;
